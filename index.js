const CLIENT_ID = 'd871746f613a4a29ace9148a3ffb81a8'; 
        const REDIRECT_URI = 'https://heegarthur.github.io/spotify-wrapped/';  //redirect url
        ...
        function displayTracks(tracks) {
            ...
            tracksDiv.innerHTML = '<h2>Top Tracks</h2>'; 
        ...
        function displayRecentlyPlayed(tracks) {
            ...
            recentlyPlayedDiv.innerHTML = '<h2>Recent Played Tracks</h2>'; 
            tracks.forEach(item => {
